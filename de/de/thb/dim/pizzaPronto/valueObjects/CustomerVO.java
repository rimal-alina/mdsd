...
public class CustomerVO  extends PersonVO {
	 ...
	 */
	public CustomerVO(String lastName, String firstName,String fullName, String street, int houseNumber, LocalDate dob) throws NullPointerException, CustomerTooYoungException {
		super(lastName, firstName, fullName, street, houseNumber);
		id = nextId;
		nextId++;
		setDateOfBirth(dob);
	 ...
	 * 
	 */
	public CustomerVO(String lastName, String firstName, String fullName, LocalDate dob) throws NullPointerException, CustomerTooYoungException {
		this(lastName, firstName,fullName, null, 0, dob);
